...
import './homefooter.css'; // Import the styles
          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="widget course-links-widget">
                ...
                <ul className="courses-link-list" style={{listStyle:'none'}}>
                  <li style={{textDecoration:'none'}}><a href="#"><i className="fas fa-long-arrow-alt-right"></i>Taqseem</a></li>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="widget latest-news-widget">
                ...
                <ul className="small-post-list" style={{listStyle:'none'}}>
                  <li>
